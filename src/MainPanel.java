...
/**
 * MainPanel class creates a MainPanel to store InnerPanel and other components.
 * This class acts as the Controller of the MVC pattern.
 * 
...
public class MainPanel extends JPanel {
	...
	/**
	 * Construct a MainPanel using a Model object. The constructor creates
	 * InnerPanel, a buttons to undo, and buttons to change style of the board.
	 * 
	 * @param model
	 */
	public MainPanel(Model model) {
		...
		east.addActionListener((e) -> {
			dataModel.setStyle(new Circular());
		});
		JButton west = new JButton("Rectangular Style");
		west.addActionListener((e) -> {
			dataModel.setStyle(new Rectangular());
		});
	...
	/**
	 * Override the paintComponent(Graphics) of the JPanel.
	 */
	@Override
